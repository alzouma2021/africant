...
public interface PrixOffreVoyageRepository extends JpaRepository<PrixOffreVoyage,Long> {
    ...
    PrixOffreVoyage findByOffreVoyageAndCategorieVoyageur(@Param("offreVoyageDesignation") String offreVoyageDesignation,@Param("categorieVoyageurDesignation") String categorieVoyageurDesignation , @Param("isDeleted") Boolean isDeleted);
}
